        ...
        <div class="container-fluid">
          ...
          <div class="be-right-navbar be-right-navbar-flex">
            ...
            <ul class="nav navbar-nav navbar-right be-user-nav">
              <li class="dropdown"><a href="#" data-toggle="dropdown" role="button" aria-expanded="false" class="dropdown-toggle"><img src="/FPPES/assets/user/avatar.jpeg" alt="Avatar"><span class="user-name"><?= $_SESSION["14c4b06b824ec593239362517f538b29"] ?></span></a>
                <ul role="menu" class="dropdown-menu">
                  <li>
                    <div class="user-info">
                      <div class="user-name"><?= $_SESSION["14c4b06b824ec593239362517f538b29"] ?></div>
                    </div>
                  </li>
