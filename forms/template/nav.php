        ...
        <div class="container-fluid">
          ...
          <div class="be-right-navbar be-right-navbar-flex">
            ...
            <ul class="nav navbar-nav navbar-right be-user-nav">
              <li class="dropdown"><a href="#" data-toggle="dropdown" role="button" aria-expanded="false" class="dropdown-toggle"><img src="/WAZE/assets/img/avatar.png" alt="Avatar"><span class="user-name"><?= $_SESSION["4040592cec1880aa70936989f05e7c31"] ?></span></a>
